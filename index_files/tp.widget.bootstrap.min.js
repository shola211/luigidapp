! function n(s, o, r) {
    ...
    2: [function(e, t, i) {
        ...
        (function(e, t, i) {
            ...
            value: function(d) {
                var e = !0,
                    ...
                    i = void 0;
                try {
                    for (var n, s = d[Symbol.iterator](); !(e = (n = s.next()).done); e = !0) {
                        var o = n.value;
                        if ("childList" === o.type) {
                            var r = !0,
                                a = !1,
                                l = void 0;
                            try {
                                for (var c, u = o.addedNodes[Symbol.iterator](); !(r = (c = u.next()).done); r = !0) 1 === c.value.nodeType && this.handleMutations()
                            } catch (e) {
                                a = !0, l = e
                            } finally {
                                try {
            ...
            value: function() {
                ...
                this.observer.disconnect(), 0 < e.length && this.mutationHandler(e)
            }
        }]);
        var s = o;
        ...
        function o(e, t) {
            ...
            this.document = e, this.observer = new MutationObserver(this.mutationHandler.bind(this)), this.handleMutations = this.debounce(t, 200), this.start = this.start.bind(this), this.stop = this.stop.bind(this)
        }
        i.default = s
    }, {}],
    3: [function(e, t, i) {
        ...
        function h(e) {
            try {
                ...
                t.setAttribute("type", "application/ld+json"), t.innerHTML = JSON.stringify(e), document.head.appendChild(document.createComment("Added by Trustpilot")), document.head.appendChild(t), document.head.appendChild(document.createComment("/Added by Trustpilot")), c = !0
            } catch (e) {}
        }
        var f = e("./xhr.js");
        var p = {
        ...
        t.exports = function(e) {
            if (c) return !1;
            if (e.schemaType && e.location) return a = (r = e).businessunitId, l = r.location, u = r.locale, r = r.templateId, r = ["url=" + encodeURIComponent(window.location.href), "templateId=" + r, "locale=" + u].join("&"), f.xhrGet({
                url: "https://widget.trustpilot.com" + ("/data/jsonld/business-unit/" + a + "/location/" + l) + "?" + r,
                success: function(e) {
                    e.url = document.location.href, e["@id"] = document.location.href, h(e)
                },
                error: function(e) {
                    console.error(e)
                }
            ...
            if (e.sku) {
                u = e.templateId === p.productReviewsCarousel;
                if ((e.templateId === p.productReviewsSEO || e.templateId === p.productReviewsMultiSourceSEO) && e.name || u && "Product" === e.schemaType) return l = (a = e).businessunitId, r = a.locale, e = a.templateId, t = a.name, i = a.sku, d = a.reviewnumber, n = a.price, s = a.priceCurrency, a = a.availability, r = r && r.split("-")[0], l = "https://widget.trustpilot.com" + (e === p.productReviewsMultiSourceSEO ? "/data/jsonld/business-unit/" + l + "/product-imported" : "/data/jsonld/business-unit/" + l + "/product") + "?sku=" + encodeURIComponent(i) + "&numberOfReviews=" + (d || 10) + (t ? "&productName=" + encodeURIComponent(t) : "") + "&language=" + r + "&templateId=" + e + "&url=" + encodeURIComponent(window.location.origin + window.location.pathname), o = n && s && a ? {
                    "@type": "Offer",
                    priceCurrency: s,
                    price: n,
                    availability: a
                    ...
                    url: l,
                    success: function(e) {
                        o && (e.offers = o), (e.offers || e.review || e.aggregateRating) && h(e)
                    },
                    error: function(e) {
                        console.error(e)
                    }
    ...
    4: [function(e, u, t) {
        ...
        i(l, [{
            ...
            value: function() {
                var e = !(!document.currentScript || !document.currentScript.hasAttribute("data-dynamic"));
                "loading" !== this.document.readyState ? (this.findAndApplyWidgets(), e && this.observer.start()) : (this.document.addEventListener("DOMContentLoaded", this.findAndApplyWidgets.bind(this)), e && this.document.addEventListener("DOMContentLoaded", this.observer.start))
            }
        }, {
            key: "applyWidgetFromDomElement",
            value: function(t, e) {
                Boolean(t.firstChild && "IFRAME" === t.firstChild.tagName || -1 < this.widgets.findIndex(function(e) {
                    return e.container === t
                })) && !e || this.createWidget(t)
            }
        }, {
            ...
            value: function(e) {
                ...
                return n.initialize(), this.stats.applied += 1, this.stats.applyFromDomCalls += 1, this.widgets.push(n), this.onRemove(e, function() {
            ...
            key: "isDetached",
            value: function(e) {
                return e.parentNode !== document && (null === e.parentNode || this.isDetached(e.parentNode))
            }
        }, {
            key: "businessUnitId",
            get: function() {
        ...
        function l(e, t, i) {
            ...
            this.window = e, this.document = t, this.widgets = [], this.stats = {
                ...
                applyFromDomCalls: 0,
                elements: 0
            }, this.version = i, this.observer = new r.default(t, function() {
        ...
        n(l, [{
            ...
            value: function() {
                var e = this.iframeData || {
                    ...
                    t = o.title[this.dataset.locale] || o.title[o.defaultLocale];
            ...
            value: function(e, t) {
                var i, n;
                this._iframe = (i = this.getIframeOptionsFromData(), (n = document.createElement("iframe")).style.position = i.position, n.style.zIndex = i.zindex, n.style.margin = i.margin, n.style.top = i.top, n.style.bottom = i.bottom, n.style.left = i.left, n.style.right = i.right, n.style.height = i.height, n.style.width = i.width, n.style.minHeight = i.minHeight, n.style.minWidth = i.minWidth, n.style.borderStyle = i.borderStyle, n.style.backgroundColor = i.backgroundColor, n.style.display = i.display, n.style.overflow = i.overflow, n.allowTransparency = i.allowTransparency, n.title = i.title, n.loading = i.loading || "auto", n.src = i.src, i.allow && (n.allow = i.allow), n), e.appendChild(this._iframe), this._iframe.addEventListener("load", t)
            }
        }, {
            key: "sendMessage",
            value: function(e) {
    ...
    9: [function(e, t, i) {
        ...
        i.defaultLocale = "en-US", i.title = (n(i = {
