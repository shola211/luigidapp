! function(e, t) {
    ...
    var g = "PAGE_VIEW",
        m = "AUTO_10_SEC_ON_PAGE",
        w = "dicbo",
        b = "dicbo_id",
        C = "dicbo_fetch",
        _ = "ob_cvr_pixel_domain",
        k = "obamplify",
        E = "obtp",
        O = new(function() {
            function e() {
            ...
            return e.prototype.validate = function(e) {
                return e.content && e.content.id, e.orderValue && !e.currency ? (p(h.Warning, "Order value reported but no currency is declared", e.name), !1) : e.currency && -1 === this.validCurrencies.indexOf(e.currency) ? (p(h.Warning, "Currency not recognized", e.name), !1) : e.orderValue && !this.validNumber.test(e.orderValue) ? (p(h.Warning, "Order value can only be a positive number", e.name), !1) : e.name === g || e.name == m || this.validNameRegX.test(e.name) ? !(e.name !== g && e.name.length > this.validNameLength && (p(h.Warning, "Event name length cannot exceed 100 characters", e.name), 1)) : (p(h.Warning, "Event Name invalid", e.name), !1)
            }, e
        }()),
        S = new(function() {
            function e() {}
        ...
        I = new(function() {
            ...
            return e.prototype.on = function(e, t) {
                ...
                for (var t = [], n = 1; n < arguments.length; n++) t[n - 1] = arguments[n]; - 1 !== Object.keys(this.listeners).indexOf(e) && this.listeners[e].forEach((function(e) {
                    return e.call.apply(e, P([null], t, !1))
                }))
            }, e
        }()),
        T = function() {
    ...
    function x(e, t) {
        (new Image).src = L() + "/log?apiObjVersion=" + t.version + "&obtpVersion=" + t.obtpVersion + "&msg=" + encodeURIComponent('{"error":"LOAD", "apiObjVersion": ' + t.version + ', "marketerID": ' + t.marketerId + ', "referrer": ' + document.URL + ', "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","message":"' + e.message + '"}}')
    }

    function A(e) {
        return "".concat(L(), "/unifiedPixel")
    }

    function L() {
        return N() ? "//p.teads.tv/obtr" : "//tr.outbrain.com"
    }

    function N() {
        try {
            return !!ue.loadedBy && ("string" != typeof ue.loadedBy ? (x({
                message: "loadedBy - ".concat(ue.loadedBy, " - is not a string")
            }, ue), !1) : "teads" === ue.loadedBy.toLowerCase())
        } catch (e) {
            return x(e, ue), !1
        }
    }
    var B = function() {
            ...
            return e.prototype.set = function(e, t, n, o) {
                if (void 0 === n && (n = 7), this.hasConsent) {
                    ...
                    var a = "expires=" + i.toUTCString(),
                        s = "".concat(b, "=").concat(encodeURIComponent(JSON.stringify(r))),
                        c = s + "; " + a + "; path=/;";
                    o && (c += "domain=" + o + ";"), N() ? teads_setOutbrainCookieOnTeads(s) : document.cookie = c
                ...
                var e, t, n = N() ? teads_getOutbrainCookieFromTeads() : document.cookie;
                if (!n) return {};
        ...
        W = function() {
            ...
            return e.prototype.hasConsentHandler = function() {
                ...
                var t = e.consents,
                    n = !0;
                return [1, 3].forEach((function(e) {
                    t.hasOwnProperty(e) && !1 === t[e] && (n = !1)
                })), n
            }, e.prototype.hasPurposeConsentImproved = function(e) {
                if (!(null == e ? void 0 : e.consents)) return !1;
                var t = e.consents;
                ...
                if (!1 !== e && "cmpuishown" !== e.eventStatus)
                    if (t && "tcloaded" === (null == e ? void 0 : e.eventStatus) || "useractioncomplete" === (null == e ? void 0 : e.eventStatus)) {
                        var n = this.hasPurposeConsentImproved(e.purpose) ? 2 : 1;
                        e && e.vendor && e.vendor.consents && !1 === e.vendor.consents[164] || !e || !this.hasPurposeConsent(e.purpose) ? this.invokeCallBacks(!1, n) : this.invokeCallBacks(!0, n), this.removeTcfApiEventListeners()
                    } else this.invokeCallBacks(!0, 3)
            }, e.prototype.invokeCallBacks = function(e, t) {
                for (void 0 === t && (t = 2); this.cbs.length;) this.cbs.shift()(e, t)
            ...
            return e.prototype.hasConsentHandler = function() {
                ...
                return t = this, n = void 0, r = function() {
                    ...
                    return function(e, t) {
                        ...
                        return t = ue.zone === d.Default, n = ue.queue, o = n.length && n.some((function(e) {
                            var t = e[2];
        ...
        te = function() {
            ...
            return e.prototype.checkHasConsent = function(e) {
                var t = this,
                    n = function(n, o, r) {
                        for (void 0 === o && (o = void 0), void 0 === r && (r = 0); t.timeouts.length;) clearTimeout(t.timeouts.shift());
                        e(n, o, r)
                    },
                    o = ue.zone === d.Default;
                try {
                    ...
                    if (this.hasPublisherConsent()) return void this.handleConsentByCmp([ee], n, o);
                    this.keepLookingForCmp(n, o), n(o)
                } catch (e) {
                    throw n(o), e
                }
            }, e.prototype.getConsentHandlerService = function() {
                for (var e = [], t = 0, n = X; t < n.length; t++) {
                    var o = n[t],
                        r = o.service,
                        i = o.type;
                    Q(i) && r.hasConsentHandler() && e.push(o)
                }
                return e
            }, e.prototype.handleConsentByCmp = function(e, t, n) {
                if (0 !== e.length)
                    for (var o = !1, r = function(e, n) {
                            e.handleConsent((function(e, r) {
                                !o && e && (o = !0, t(!0, n, r))
                            }))
                ...
                return ue.zone === d.EuZone1 && Y.hasConsentSignal()
            }, e
        }(),
        ne = new(function() {
            function e() {}
        ...
        ie = function() {
            function e() {
                this.hasConsent = !1, this.isCheckConsentRespond = !1, this.gdprValidatorService = new te
            }
            return e.prototype.drainQueue = function(e, t) {
                var n = this;
                void 0 === t && (t = null);
                for (var o = !1, r = function() {
                        var r = ue.queue.shift(),
                            i = r[0],
                            a = r[1],
                            s = r[2];
                        if (!a) return x(new Error("Can't dispatch pixel, event name is missing"), ue), "continue";
                        ...
                        if (a === g && !s) {
                            ...
                            var r, c;
                            r = e.toString(), c = n.getRequestParams(a, r, s), "track" === i ? (O.validate(c), n.firePixel(c, t)) : p(h.Error, "Command type ".concat(i, " is not recognized."), a)
                        }(e)
                    }; ue.queue.length;) r()
            }, e.prototype.firePixel = function(e, t) {
                void 0 === t && (t = null), !e.cht && this.consentHandlerType && (e.cht = this.consentHandlerType), "tcf" === this.consentHandlerType && (e.np = this.noPurposes), this.fire(e, this.hasConsent, t)
                ...
                if (void 0 === n && (n = null), t) {
                    ...
                    if (e.name !== m || i) {
                        var a = re(re(re({}, r), function(e) {
                            ...
                            c = e.marketerId;
                        try {
                            window.fetch("".concat(A(), "?").concat(s(a)), {
                                keepalive: !0,
                                method: "GET",
                                mode: "no-cors",
                                credentials: "include",
                            ...
                            if (x(e, ue), ne.isTest(c, 100))(n || navigator).sendBeacon(A() + "?" + s(a));
                            else {
                                var u = new Image;
                                u.referrerPolicy = "no-referrer-when-downgrade", u.src = A() + "?" + s(a)
                            }
                        }
                    }
                }
            }, e.prototype.dispatch = function() {
                var e = this.getUniqueMarketers(ue.marketerId);
                ...
                if (this.isCheckConsentRespond) this.hasConsent && this.drainQueue(e);
                    ...
                    var t = navigator;
                    this.gdprValidatorService.checkHasConsent(function(n, o, r) {
                        this.isCheckConsentRespond = !0, n && (I.dispatch(v, n), this.hasConsent = n, this.consentHandlerType = o, this.noPurposes = r, this.drainQueue(e, t))
                    }.bind(this))
                }
                ...
                var o, r = function() {
                    ...
                    i = re(re({}, n), ((o = {
                        ...
                        g: this.hasGtm() ? 1 : 0,
                        zone: ue.zone
                    })["".concat("obApi", "Version")] = ue.version ? ue.version : "-1", o["".concat(E, "Version")] = ue["".concat(E, "Version")], o));
                ...
                var e, t = S.getParamFromUrl(w);
                if (t) {
                    var n = S.getParamFromUrl(_);
                    j.set(b, t, 7, n), e = t
                } else e = j.get(b);
    ...
    var se = window.__$$OBGeoZone || ae.zone,
        ce = window.__$$loadedBy || void 0,
        ue = new function(e, t, n) {
            var o = window.obApi,
                r = function() {
            ...
            }, r["".concat(E, "Version")] = "2.18.179", e.obApi = r, this.apiObj = r
        }(window, se, ce).apiObj,
        pe = new te,
        le = function() {
            function e(e) {
            ...
            return e.prototype.getCachedClickId = function() {
                ...
                if (!j.get(b) && (n = parseInt(j.get(C)), isNaN(n) || Date.now() - n > 3e5) && !S.getParamFromUrl(w)) {
                    var r = this;
                    ue.setCachedClickId = (e = function() {
                        var e, t = document.createElement("script"),
                            n = "string" == typeof(e = ue.marketerId) ? e : a(e) ? e.join(",") : void 0;
                        t.src = L() + "/cachedClickId?marketerId=" + n, o.body.appendChild(t)
                    }, t = function() {
                        j.set(C, Date.now(), 5 / 1440)
                    }, pe.checkHasConsent((function(t) {
                        t && e()
                    })), r.eventBusService.on(v, (function(t) {
                        t && e()
                    })), function(e) {
                        if ("optout" !== e)
                            if ("NoClickId" === e) ue.zone === d.Default ? t() : (pe.checkHasConsent((function(e) {
                                e && t()
    ...
    try {
        ...
        ! function(e) {
            ...
            if (history.pushState && history.replaceState && window.addEventListener) {
                var e = this,
                    t = function(t) {
                        location.href !== e.lastVisited && t && (e.lastVisited = location.href, ue("track", g))
                    };
            ...
            de = e, e && (function() {
                ...
                window.addEventListener("message", o), null === (t = null === (e = null === top || void 0 === top ? void 0 : top.window.opener) || void 0 === e ? void 0 : e.postMessage) || void 0 === t || t.call(e, {
                    ...
                    content: {
                        marketerId: ue.marketerId
                    }
                }, "*");
                try {
                    Array.isArray(ue.marketerId) && ue.marketerId.filter((function(e) {
                        return !!e
                    })).slice(0, 9).forEach((function(e) {
                        return n("".concat(N() ? "https://p.teads.tv/obwave/" : "https://wave.outbrain.com/", "mtWavesBundler/handler/").concat(e.trim()))
                    }))
                } catch (e) {
                    x(e, ue)
                }
                ...
                if ("browsingTopics" in document && "featurePolicy" in document && window.document.featurePolicy.allowsFeature("browsing-topics")) {
                    var e = N() ? "https://p.teads.tv/obtp/topics" : "https://amplify.outbrain.com/topics";
                    fetch(e, {
                        browsingTopics: !0
                    }).then((function(e) {}))
                }
            }())
        })), ue.dispatch.apply(ue), new le(I).getCachedClickId()
    } catch (e) {
        de && x(e, ue)
    }
    return i
